 ...
 *****************************************************************************/
RecTransform3D::RecTransform3D(const RecVector3D& vecX, const RecVector3D& vecY, const RecVector3D& vecZ)
{
    RecVector3D vX(vecX);
    RecVector3D vY(vecY);
    RecVector3D vZ(vecZ);
 ...
 *****************************************************************************/
RecTransform3D::RecTransform3D(const RecVector3D& vecX, const RecVector3D& vecY, const RecVector3D& vecZ, const RecVector3D& origin)
{
    RecVector3D vX(vecX);
    RecVector3D vY(vecY);
    RecVector3D vZ(vecZ);
...
RecTransform3D RecTransform3D::inverse(void)
{
  ...
  inv.matrixPP[0][3] = (-matrixPP[0][0]*matrixPP[0][3] - matrixPP[1][0]*matrixPP[1][3] - matrixPP[2][0]*matrixPP[2][3]);

  inv.matrixPP[1][0] = matrixPP[0][1];
  inv.matrixPP[1][1] = matrixPP[1][1];
  inv.matrixPP[1][2] = matrixPP[2][1];
  inv.matrixPP[1][3] = (-matrixPP[0][1]*matrixPP[0][3] - matrixPP[1][1]*matrixPP[1][3] - matrixPP[2][1]*matrixPP[2][3]);

  inv.matrixPP[2][0] = matrixPP[0][2];
  inv.matrixPP[2][1] = matrixPP[1][2];
  inv.matrixPP[2][2] = matrixPP[2][2];
  inv.matrixPP[2][3] = (-matrixPP[0][2]*matrixPP[0][3] - matrixPP[1][2]*matrixPP[1][3] - matrixPP[2][2]*matrixPP[2][3]);
...
{
    RecTransform3D a;
    a.matrixPP[0][0] = b.matrixPP[0][0]*c.matrixPP[0][0] + b.matrixPP[0][1]*c.matrixPP[1][0] + b.matrixPP[0][2]*c.matrixPP[2][0];
    a.matrixPP[0][1] = b.matrixPP[0][0]*c.matrixPP[0][1] + b.matrixPP[0][1]*c.matrixPP[1][1] + b.matrixPP[0][2]*c.matrixPP[2][1];
    a.matrixPP[0][2] = b.matrixPP[0][0]*c.matrixPP[0][2] + b.matrixPP[0][1]*c.matrixPP[1][2] + b.matrixPP[0][2]*c.matrixPP[2][2];
    a.matrixPP[0][3] = b.matrixPP[0][0]*c.matrixPP[0][3] + b.matrixPP[0][1]*c.matrixPP[1][3] +
                       b.matrixPP[0][2]*c.matrixPP[2][3] + b.matrixPP[0][3];
  
    a.matrixPP[1][0] = b.matrixPP[1][0]*c.matrixPP[0][0] + b.matrixPP[1][1]*c.matrixPP[1][0] + b.matrixPP[1][2]*c.matrixPP[2][0];
    a.matrixPP[1][1] = b.matrixPP[1][0]*c.matrixPP[0][1] + b.matrixPP[1][1]*c.matrixPP[1][1] + b.matrixPP[1][2]*c.matrixPP[2][1];
    a.matrixPP[1][2] = b.matrixPP[1][0]*c.matrixPP[0][2] + b.matrixPP[1][1]*c.matrixPP[1][2] + b.matrixPP[1][2]*c.matrixPP[2][2];
    a.matrixPP[1][3] = b.matrixPP[1][0]*c.matrixPP[0][3] + b.matrixPP[1][1]*c.matrixPP[1][3] +
                       b.matrixPP[1][2]*c.matrixPP[2][3] + b.matrixPP[1][3];
  
    a.matrixPP[2][0] = b.matrixPP[2][0]*c.matrixPP[0][0] + b.matrixPP[2][1]*c.matrixPP[1][0] + b.matrixPP[2][2]*c.matrixPP[2][0];
    a.matrixPP[2][1] = b.matrixPP[2][0]*c.matrixPP[0][1] + b.matrixPP[2][1]*c.matrixPP[1][1] + b.matrixPP[2][2]*c.matrixPP[2][1];
    a.matrixPP[2][2] = b.matrixPP[2][0]*c.matrixPP[0][2] + b.matrixPP[2][1]*c.matrixPP[1][2] + b.matrixPP[2][2]*c.matrixPP[2][2];
    a.matrixPP[2][3] = b.matrixPP[2][0]*c.matrixPP[0][3] + b.matrixPP[2][1]*c.matrixPP[1][3] +
                       b.matrixPP[2][2]*c.matrixPP[2][3] + b.matrixPP[2][3];
    return a;
}
...
{
    RecPoint3D newpt;
    newpt.x = tr.matrixPP[0][0]*pt.x + tr.matrixPP[0][1]*pt.y + tr.matrixPP[0][2]*pt.z + tr.matrixPP[0][3];
    newpt.y = tr.matrixPP[1][0]*pt.x + tr.matrixPP[1][1]*pt.y + tr.matrixPP[1][2]*pt.z + tr.matrixPP[1][3];
    newpt.z = tr.matrixPP[2][0]*pt.x + tr.matrixPP[2][1]*pt.y + tr.matrixPP[2][2]*pt.z + tr.matrixPP[2][3];
    return newpt;
}
...
{
    return( (fabs(a.matrixPP[0][0] - b.matrixPP[0][0]) < RecTransform3D::tolerance) &&
