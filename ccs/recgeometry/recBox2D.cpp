 ...
 *     PROJECT:	Blitz
 *        FILE:	RecBox2D.cpp
 * DESCRIPTION: Implementation of a 2D Box class
 *     CREATED: 2003/03/06
 *    
 * HISTORY:
 *
 ...
 * Adding recGeometry.
 *
 * Revision 1.3  2004/04/23 19:04:27  bode
 * Added additional functionality to recBox2d
 *
 * Revision 1.2  2003/11/18 15:42:19  nickv
 * Added isInside/OutsideTiled methods for use when the bounding box is tiled
 * across a surface. They consider points on the lower and left perimeter to
 * be inside the box, but points on the upper and right perimeters to be
 * outside the box
 *
 * Revision 1.1  2003/03/11 22:02:58  bode
 * Initial Release
 *
 *
 *****************************************************************************/
...
using namespace std; 	//MAT 10-9-06 added for debugging
/*****************************************************************************
 ...
 *****************************************************************************/
RecAxisAlignedBox2D::RecAxisAlignedBox2D(const 
                                         RecAxisAlignedBox2D& box):min(box.min),
                                         max(box.max) { }
